...
from backend.restaurant_api.routes.auth import auth_bp
from backend.restaurant_api.routes.admin_menu import admin_menu_bp
from backend.restaurant_api.routes.servicios import servicios_bp
from backend.restaurant_api.services.servicios_service import (obtener_servicios, obtener_servicio_id, crear_servicio_db, actualizar_servicio_db, eliminar_servicio_db)
from backend.restaurant_api.services.admin_menu_service import (obtener_menu_admin_service, obtener_plato_service, cambiar_estado_plato_service, actualizar_parcial_plato_service, eliminar_plato_service, crear_plato_service)
from backend.restaurant_api.db import query_db, execute_db
from backend.restaurant_api.validators.admin_menu_validator import (validar_crear_plato, validar_id_plato)
from backend.restaurant_api.validators.servicios_validator import (validar_servicio)
...
def ver_menu():
    try:
        ...
        return render_template('gestion/menu.html', platos=None)
